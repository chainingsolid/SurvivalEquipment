package chainingSolid.survivalEquipment.util.enchantedBagViewerGui;
...
public class EnchantedBagInventory extends GenericInventory {
	...
	public void setThisBagInUse(ItemStack stack){
		...
		stack.getTagCompound().setBoolean(EnchantedBag.IS_OPEN, true);
	}
	
	public void setThisBagNoLongerInUse(ItemStack stack){
		Util.nullNBTTagCheck(stack);
		stack.getTagCompound().setBoolean(EnchantedBag.IS_OPEN, false);
	}
