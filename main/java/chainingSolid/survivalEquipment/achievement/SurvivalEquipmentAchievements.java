...
public class SurvivalEquipmentAchievements {
	...
	public static void addAchievements(){
		...
		theFastMiner = new Achievement[Enchantment.efficiency.getMaxLevel()];
		...
		theLongMiner = new Achievement[Enchantment.unbreaking.getMaxLevel()];
		...
		slipperyFast = makeAchievment("speed machine", 5, 0, new ItemStack(BlockList.slipperyPath), null);
		achievement.add(slipperyFast);
		heavyHitting = makeAchievment("heavy hitting", 5, 2, new ItemStack(ItemList.hammer), null);
		achievement.add(heavyHitting);
