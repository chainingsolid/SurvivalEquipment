...
public class SlipperyPathSlab extends BlockSlab implements LoadableBlock{

	public SlipperyPathSlab(boolean par2, Material material) {
		super(par2,material);
		this.setHardness(2F);
